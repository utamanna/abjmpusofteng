...
namespace TICSET.UsersDataSet1TableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [user] ([username], [password], [first_name], [last_name]) VALUES (@u" +
                "sername, @password, @first_name, @last_name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [user] SET [username] = @username, [password] = @password, [first_name] = " +
                "@first_name, [last_name] = @last_name WHERE (([username] = @Original_username))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TICSET.Properties.Settings.Default.UsersConnectionString1;
        }
        ...
        public virtual int Insert(string username, string password, string first_name, string last_name) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, string first_name, string last_name, string Original_username) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string first_name, string last_name, string Original_username) {
            return this.Update(Original_username, password, first_name, last_name, Original_username);
        }
    }
